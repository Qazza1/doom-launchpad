...
/// @notice No-broadcast rehearsal of the seven-step permissionless successor deployment.
/// @dev There is deliberately no vm.startBroadcast call in this script.
contract DeployRobinhoodPublicV2Rehearsal is Script {
    ...
    function run()
        ...
        returns (
            ...
            DoomPublicLaunchFactoryV2 factory
        )
    {
        if (!vm.envOr("ROBINHOOD_PUBLIC_V2_REHEARSAL_ACK", false)) {
        ...
        _assert(factory.FIRST_LAUNCH_ID() == 2, "FIRST_LAUNCH_ID_MISMATCH");
        _assert(factory.FINAL_LAUNCH_ID() == 100, "FINAL_LAUNCH_ID_MISMATCH");
        _assert(factory.MAX_LAUNCHES() == 99, "PUBLIC_LAUNCH_CAP_MISMATCH");
        _assert(factory.launchCount() == 0, "PUBLIC_LAUNCH_COUNT_MISMATCH");
